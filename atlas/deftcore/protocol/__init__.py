...
class Protocol(object):
    ...
    TASK_PARAM_TEMPLATES = {
        ...
        TaskParamName.HEPMC_OUTPUT: """{
            ...
            "token": "ATLASDATADISK",
            "type": "template",
            "value": "{{name}}={{data_type}}.{{task_id|stringformat:\".08d\"}}._${SN}.gz"
        }""",
        # FIXME: OverlayTest
...
class TaskDefConstants(object, metaclass=Constants):
    ...
    DEAFULT_CONTAINER_RELEASE_PATH = '{base}/{container_name}{arch}/usr/{project}/{release}/InstallArea/'
    DEAFULT_CONTAINER_BASE_RELEASE_PATH_BASE = '/cvmfs/unpacked.cern.ch/registry.cern.ch'
    DEAFULT_OLD_CONTAINER_BASE_RELEASE_PATH_BASE = '/cvmfs/unpacked.cern.ch/registry.hub.docker.com'
    DEAFULT_CONTAINER_BASE_RELEASE_PATH = '{base}/{container_name_base}'
