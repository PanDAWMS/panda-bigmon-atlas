export class DATASETS_NOMENCLATURE {
   public static readonly STREAMS = [ 'physics_Main',
 ...
 'physics_EgammaPEBTLA',
 'physics_DarkJetPEBTLA',
 'physics_CosmicCalo',
 'physics_CC',
 'physics_Background',
 'express_express',
