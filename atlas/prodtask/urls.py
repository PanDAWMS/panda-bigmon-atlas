...
urlpatterns = patterns('',
    ...
    url(r'^slice_by_task/(?P<task_id>\d+)/$',        'atlas.prodtask.task_views.slice_by_task',       name='slice_by_task'),
    ...
    url(r'^finish_action/(?P<wstep_id>\d+)/$', 'atlas.prodtask.waiting_actions.finish_action',name='finish_action'),
    url(r'^cancel_action/(?P<wstep_id>\d+)/$', 'atlas.prodtask.waiting_actions.cancel_action',name='cancel_action'),
    ...
    url(r'^task_chain_obsolete_action/$', 'atlas.prodtask.task_manage_views.task_chain_obsolete_action', name='task_chain_obsolete_action'),
    ...
    url(r'^prestage/$', 'atlas.prodtask.views.pre_stage_approve',name='pre_stage_approve'),
    url(r'^ongoing_prestage/$', 'atlas.prodtask.views.pre_stage_approved',name='pre_stage_approved'),
