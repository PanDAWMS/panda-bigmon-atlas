...
connections.create_connection(hosts=DKB_ES7['hosts'],http_auth=(DKB_ES7['login'], DKB_ES7['password']), verify_certs=DKB_ES7['verify_certs'])
ES7 = Elasticsearch(hosts=DKB_ES7['hosts'],http_auth=(DKB_ES7['login'], DKB_ES7['password']), verify_certs=DKB_ES7['verify_certs'])
