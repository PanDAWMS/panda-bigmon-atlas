...
class LoginTest(TestCase):
    ...
    def test_update_user(self):
        ...
        self.assertEqual(updated_user.email, 'new_user_super@example.com')
        ...
        self.assertEqual(updated_groups[0].id, 1)
    ...
    def test_create_user(self):
        ...
        self.assertEqual(user.username, environ[settings.META_USERNAME])
        self.assertEqual(user.email, environ[settings.META_EMAIL])
        self.assertEqual(user.first_name, environ[settings.META_FIRSTNAME])
        self.assertEqual(user.last_name, environ[settings.META_LASTNAME])
        self.assertEqual(user.is_active, settings.SHIB_SSO_CREATE_ACTIVE)
        self.assertEqual(user.is_staff, settings.SHIB_SSO_CREATE_STAFF)
        self.assertEqual(user.is_superuser, settings.SHIB_SSO_CREATE_SUPERUSER)