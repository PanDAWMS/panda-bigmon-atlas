...
urlpatterns = [
    ...
    url(r'^step_action_in_request/(?P<reqid>\d+)/$', step_action_in_request, name='step_action_in_request'),
    ...
    url(r'^derivation_requests/$', derivation_requests,name='derivation_requests'),
